#### TO DOS
1. FIGURE OUT HOW TO DO WITH UPGRADED REQUIRED RESPONSE
2. WRITE UNIT TESTS FOR API-CALLS.JS
3. WHAT ARE ONCLICK FUNCTONIS OF FUNCTIONS IN API-CALLS.JS MEANT TO DO, EVEN AFTER SUBSCRIPTIONS
    ONCLICK FUNCTIONS SHOULD FETCH E.G EVENTS, MARKETS ETC --- MAYBE FIGURING UPGRADED REQUIRED RESPONSE WILL SOLVE THIS 
